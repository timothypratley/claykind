...
```
<div style="width:100%;"><script>vegaEmbed(document.currentScript.parentElement, {"encoding":{"y":{"field":"y","type":"quantitative"},"fill":{"field":"z","type":"nominal"},"size":{"field":"w","type":"quantitative"},"x":{"field":"x","type":"quantitative"}},"mark":"point","data":{"values":[{"y":-0.23870171446962463,"w":2,"z":2,"x":0},{"y":-0.6375279841272652,"w":2,"z":5,"x":1},{"y":-0.16152245642553376,"w":2,"z":2,"x":2},{"y":0.09054289833566298,"w":3,"z":6,"x":3},{"y":-0.28753808836172534,"w":4,"z":7,"x":4},{"y":-0.6183020237404696,"w":6,"z":6,"x":5},{"y":-0.8611185395855587,"w":6,"z":1,"x":6},{"y":-0.8615222842198386,"w":5,"z":7,"x":7},{"y":-1.0686819958488156,"w":8,"z":0,"x":8}]}});</script></div>
...
```
<img src="BufferedImage@7d1f60cf: type = 6 ColorModel: #pixelBits = 32 numComponents = 4 color space = java.awt.color.ICC_ColorSpace@2d7e6c8c transparency = 3 has alpha = true isAlphaPre = false ByteInterleavedRaster: width = 256 height = 256 #numDataElements 4 dataOff[0] = 3" />
